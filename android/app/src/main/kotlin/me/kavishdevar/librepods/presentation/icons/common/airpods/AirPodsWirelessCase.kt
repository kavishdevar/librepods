...
val CommonIcons.AirPodsWirelessCase: ImageVector
    get() {
        val current = _airPodsWirelessCase
        if (current != null) return current

        return ImageVector.Builder(
            name = "AirPodsCaseWireless",
            ...
            path(
                ...
                moveTo(x = 25.4f, y = 33.63f)
                arcToRelative(a = 3.1f, b = 3.1f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 3.04f, dy1 = -2.97f)
                arcToRelative(a = 3.03f, b = 3.03f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -6.07f, dy1 = 0.0f)
                arcToRelative(a = 3.0f, b = 3.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 3.04f, dy1 = 2.97f)
                moveToRelative(dx = -9.65f, dy = 28.43f)
        ...
        }.build().also { _airPodsWirelessCase = it }
    }

@Suppress("ObjectPropertyName")
private var _airPodsWirelessCase: ImageVector? = null
