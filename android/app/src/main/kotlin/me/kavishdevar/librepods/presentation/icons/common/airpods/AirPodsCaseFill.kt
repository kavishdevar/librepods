...
val CommonIcons.AirPodsCaseFill: ImageVector
    get() {
        val current = _airPodsCaseFill
        if (current != null) return current

        return ImageVector.Builder(
            name = "AirPodsCaseFill",
        ...
        }.build().also { _airPodsCaseFill = it }
    }

@Suppress("ObjectPropertyName")
private var _airPodsCaseFill: ImageVector? = null
